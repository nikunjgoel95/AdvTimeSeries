...
#ded = ts.intersect(trend=time(cmort),temp,temp2=temp^2,part,partL4=lag(part,-4))
temp2 = temp^2
trend = time(cmort)
fit = lm(cmort ~ trend + temp + temp2 + part + lag(part,-4), na.action = NULL)
#fit = lm(cmort ~ ded, na.action=NULL)
summary(fit)
```
